        ...
        <table id="users-table" class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('admin.buyer.edit', $sale->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                        <form action="<?php echo e(route('admin.buyer.destroy', $sale->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\cris\resources\views/dashboard/show.blade.php ENDPATH**/ ?>